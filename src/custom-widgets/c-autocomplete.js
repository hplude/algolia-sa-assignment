...
const autoComplete = connectAutocomplete(
  ({ indices, refine, widgetParams }, isFirstRendering) => {
    ...
    indices.forEach(index => {
    	if (index.results) {
    		index.hitType = _getHitType(index); 
...
// Helper function to determine which hitType (the displayed value in the UI) 
// to assign to each index
const _getHitType = index => {
